...
1. **Linux-like Environment:**
   ...
   - [Download][dl-cygwin-32] and Install [**Cygwin**][cygwin].
...
1. [Download][dl-repo] or Clone\* this repo and Open it in VS Code  
   <br/>
   ```bash
   git clone https://github.com/Khalid-154/OS_Project
   cd OS_Project
   code .
   ```
...
[dl-repo]: https://github.com/Khalid-154/OS_Project/archive/master.zip
